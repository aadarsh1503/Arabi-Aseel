...
const SpecialsMenu = () => {
  ...
  return (
    <div className="container min-h-screen mx-auto max-w-6xl py-14 px-4">
      <h2 className="text-center text-4xl font-semibold mb-8 text-black">
        {t('specials_menu')} {/* Translation key */}
      </h2>
  
      {/* Tab Navigation */}
      <div className="flex justify-center mb-8">
        <div className="border-2 border-black rounded-lg p-1 bg-white shadow-lg w-full max-w-lg">
          ...
          >
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-start mb-2">
                ...
                <span className="text-black text-sm ">{item.rating}.00</span>
              ...
              <button className="flex items-center justify-start mt-4 py-1 px-3 bg-brown text-white  rounded-full transition duration-300 ease-in-out text-sm">
