        ...
        <div className={`shadow-lg rounded-lg p-4 w-80 mt-2 relative animate-slide-up`}>
          ...
          <div className="p-4 flex flex-col space-y-4">
            ...
            <button
              ...
              className="bg-gray-200 text-green-700 p-3 rounded-lg shadow-md hover:bg-gray-300 transition duration-300 flex items-center justify-center text-lg" // Added text-lg for larger text
            >
              <FaWhatsapp className="mr-2" size={20} /> {/* Increased icon size and aligned */}
              Sales
            </button>
