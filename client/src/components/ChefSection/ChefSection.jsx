...
const ChefsSection = ({ isRTL }) => {
  return (
    <div dir={isRTL ? "rtl" : "ltr"} className="flex flex-col min-h-screen font-poppins items-center py-12">
      {/* Section Title */}
      ...
      <div className="flex flex-col sm:flex-row justify-center space-y-8 sm:space-y-0 sm:space-x-24">
        ...
        <div className="text-center">
          ...
          <div
            ...
            style={{
              backgroundImage:
                "url(https://img.freepik.com/premium-photo/white-square-frame_1284565-5480.jpg?w=1060)", // Replace with your image path
            }}
          >
